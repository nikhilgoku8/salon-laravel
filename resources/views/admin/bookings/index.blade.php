                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <th class="col-sm-">Address</th>
                                <th class="col-sm- center">Booking Date</th>
                                <th class="col-sm-">Package/Service</th>
                            ...
                            @if(!empty($result) && count($result) > 0)
                                @foreach($result as $row)
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="{{ route('admin.bookings.edit', $row->id) }}" class="edit_details">Edit</a>
                                            <!-- <br> -->
                                            <!-- <span class="checkbox">
