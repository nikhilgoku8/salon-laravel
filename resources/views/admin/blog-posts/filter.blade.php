            ...
            <div class="my_panel">
                <div class="inner_box ">
                    ...
                    <div class="filter_form">
                        <form id="filter_form" action="{{ route('admin.blog-posts.index') }}" method="GET">
                        <!-- @@csrf -->
                        <div class="col-sm-4">
                            <div class="input_box">
                                <label>Blog Title</label>
                                <div class="error form_error" id="form-error-q"></div>
                                <input type="text" name="q" placeholder="Blog Title" value="{{ request('q') ?? '' }}">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="input_box">
                        ...
                        <div class="col-sm-2">
                            <div class="input_box blue_filled_btn">
                                <a href="{{ route('admin.blog-posts.index').'?q=' }}" class="">Clear Filters</a>
                            </div>
                        </div>
                        <!-- <div class="col-sm-2">
