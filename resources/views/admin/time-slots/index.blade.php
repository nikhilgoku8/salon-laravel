            ...
            <div class="page-header my_style">
                ...
                <div class="right_section">
                    <div class="purple_hollow_btn">
                        <a href="{{ route('admin.time-slots.create') }}">Add New</a>
                    </div>
    ...
    <div class="row">
        <div class="fourth_row">
            ...
            <div class="my_panel">
                ...
                <div class="upper_sec">
                    <div class="left_section">
                        <div class="title">All Time Slots</div>
                            ...
                            @if(!empty($result) && count($result) > 0)
                                @foreach($result as $row)
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="{{ route('admin.time-slots.edit', $row->id) }}" class="edit_details">Edit</a>
                                            <!-- <br> -->
                                            <span class="checkbox">
  ...
  $("#delete_records").on('click',(function(e){
    ...
    if(dataID.length == 0){
        ...
        if (confirm('Are you sure you want to delete these?')) {
            $.ajax({
                type: "POST",
                url: "{{ route('admin.time-slots.bulk-delete') }}",
